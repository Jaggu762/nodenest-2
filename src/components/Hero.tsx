    ...
    <section className="pt-32 pb-20 px-4 bg-gradient-to-b from-slate-50 to-white">
      <div className="max-w-4xl mx-auto text-center">
        <h1 className="text-5xl md:text-6xl font-bold text-slate-900 mb-6">
          Free Server Hosting with <span className="text-blue-600">NodeNest</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
          ...
          <a href="https://docs.ankitgupta.com.np" className="px-8 py-4 border-2 border-blue-600 text-blue-600 rounded-lg hover:bg-blue-50 transition font-semibold text-lg">
            View Documentation
          </a>
        </div>
